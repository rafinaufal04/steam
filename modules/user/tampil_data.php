...
// jika file di include oleh file lain, tampilkan isi file
  ...
  <div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <!-- button entri data -->
      <a href="?module=form_entri_user" class="btn btn-info btn-icon-split">
              ...
              while ($data = mysqli_fetch_assoc($query)) { ?>
                ...
                <tr>
                  ...
                  <td width="70" class="text-center">
                    <div>
                      <!-- button ubah data -->
                      <a href="?module=form_ubah_user&id=<?php echo $data['id_user']; ?>" class="btn btn-info btn-circle btn-sm mr-md-1" data-toggle="tooltip" data-placement="top" title="Ubah">
