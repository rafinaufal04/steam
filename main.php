...
// jika user sudah login, tampilkan halaman konten
  ...
  <body id="page-top">
      ...
      <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="?module=dashboard">
          <div class="sidebar-brand-icon bg-white rounded-circle">
            <img src="assets/img/logo-dashboard.png" alt="Logo" width="40">
          </div>
          <div class="sidebar-brand-text mx-3">SR STEAM</div>
        </a>
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item dropdown no-arrow">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <img class="img-profile rounded-circle" src="assets/img/avatar-blue.png">
                </a>
                <!-- menu user -->
        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright &copy; 2024 - <a class="text-brand">SR Steam</a>. All rights reserved.</span>
            </div>
          </div>
        </footer>
        <!-- End of Footer -->
    ...
    <!-- maskMoney JS -->
    <script src="assets/vendor/jquery-maskmoney/jquery.maskMoney.min.js"></script>
